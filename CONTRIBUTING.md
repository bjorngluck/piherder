...
- Current production: **[v1.2.0](docs/RELEASE_v1.2.0.md)**. Next: **[v1.3.0](docs/PLAN_v1.3.0.md)** (planning). Prior: [v1.1.1](docs/RELEASE_v1.1.1.md) · [v1.1.0](docs/RELEASE_v1.1.0.md) · [v1.0.0](docs/RELEASE_v1.0.0.md).
