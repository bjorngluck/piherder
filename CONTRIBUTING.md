...
- Current production: **[v1.1.1](docs/RELEASE_v1.1.1.md)** (on [v1.1.0](docs/RELEASE_v1.1.0.md)). Next train: **[v1.2.0](docs/PLAN_v1.2.0.md)**. Prior: [v1.0.0](docs/RELEASE_v1.0.0.md) · [PLAN_v1.1.0.md](docs/PLAN_v1.1.0.md).
...
5. Run unit `pytest` locally or via CI. Playwright E2E: `./scripts/e2e-up.sh` then `pytest e2e -q` — see [e2e/README.md](e2e/README.md). For wiki edits run `mkdocs build --strict` when you can.
