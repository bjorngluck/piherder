...
[![Release](https://img.shields.io/badge/release-v0.9.0-green.svg)](docs/RELEASE_v0.9.0.md)
[![Train](https://img.shields.io/badge/train-v1.0.0-blue.svg)](docs/PLAN_v1.0.0.md)
...
- Latest release: [docs/RELEASE_v0.9.0.md](docs/RELEASE_v0.9.0.md) (last pre-production — UX · quality · **HAOS path 1**)
- Prior: [docs/RELEASE_v0.8.0.md](docs/RELEASE_v0.8.0.md) · [docs/RELEASE_v0.7.0.md](docs/RELEASE_v0.7.0.md) · [docs/FEATURE_PLAN_LAN_NMAP.md](docs/FEATURE_PLAN_LAN_NMAP.md) · operator wiki [LAN Discovery](wiki/integrations/lan-discovery.md) · [HAOS hosts](wiki/day-to-day/haos-hosts.md)
- Next (**v1.0.0** first production): [docs/PLAN_v1.0.0.md](docs/PLAN_v1.0.0.md) · plan [docs/PLAN_v0.9.0.md](docs/PLAN_v0.9.0.md) · [docs/FEATURE_PLAN_HOME_ASSISTANT.md](docs/FEATURE_PLAN_HOME_ASSISTANT.md)
