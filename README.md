...
[![Release](https://img.shields.io/badge/release-v1.5.0-green.svg)](docs/RELEASE_v1.5.0.md)
...
- **Current production:** [docs/RELEASE_v1.5.0.md](docs/RELEASE_v1.5.0.md) — Move on Celery · Reports layout. Technical record: [PLAN_v1.5.0.md](docs/PLAN_v1.5.0.md). Wiki: [Move a service](wiki/docker/service-migration.md)
- **Next train:** [docs/PLAN_v1.6.0.md](docs/PLAN_v1.6.0.md) — Mux-1 landed (operator QA) · HACS [piherder-ha](https://github.com/bjorngluck/piherder-ha) **0.2.3** · unit **75.04%**, CI fail-under **75** · v0 docs archived · script-nonce CSP (local enforce, demo Report-Only) · fail-path Move undo (**Active** on `v1.6.0-dev`; public demo already on that branch, Move off). **v1.7:** [PLAN_v1.7.0.md](docs/PLAN_v1.7.0.md)
