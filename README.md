...
- **Active train:** [docs/PLAN_v1.3.0.md](docs/PLAN_v1.3.0.md) on `v1.3.0-dev` (password / 2FA policy · console timeouts · scale lists landed · Connect as… · insights / host files)
