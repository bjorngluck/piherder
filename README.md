...
- **Next train:** [docs/PLAN_v1.6.0.md](docs/PLAN_v1.6.0.md) — HACS on HA + console mux (**Active** on `v1.6.0-dev`). **v1.7:** [PLAN_v1.7.0.md](docs/PLAN_v1.7.0.md) (remaining jobs on Celery)
