...
- **Next train:** [docs/PLAN_v1.6.0.md](docs/PLAN_v1.6.0.md) — Mux-1 landed (operator QA) · HACS [piherder-ha](https://github.com/bjorngluck/piherder-ha) **0.2.2** (Visit + fleet Lovelace card) · unit **75.04%**, CI fail-under **75** (**Active** on `v1.6.0-dev`). **v1.7:** [PLAN_v1.7.0.md](docs/PLAN_v1.7.0.md)
