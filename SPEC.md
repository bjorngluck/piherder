...
> **Status:** Historical phase checklist (v1.0 era). **Hub production:** [v1.6.0](docs/RELEASE_v1.6.0.md) · [PLAN](docs/PLAN_v1.6.0.md). Active train: [PLAN_v1.7.0.md](docs/PLAN_v1.7.0.md) on `v1.7.0-dev` (MCP-1 0.1.0, Jr-1, Jr-2, Brand-1, and Brand-2 landed; walks open). Prior: [v1.5.0](docs/RELEASE_v1.5.0.md).  
