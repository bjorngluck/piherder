...
- [ ] Home Assistant: HACS integration on HA (fleet + host devices; container/service entities from snapshots; details in PiHerder) — **v1.6 Active** Slice 1 Must / 1b Should ([PLAN_v1.6.0.md](docs/PLAN_v1.6.0.md) · [FEATURE_PLAN_HOME_ASSISTANT.md](docs/FEATURE_PLAN_HOME_ASSISTANT.md) §7)
