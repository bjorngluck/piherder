...
- [x] **Test suite (pytest)** — path policy, OS patch, container summary, encrypt, apply steps, password policy, restore policy, RBAC helpers, apply-schedule skip reasons, job progress/`job_public_dict` (`tests/`)
