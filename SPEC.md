...
> **Status:** Historical phase checklist (v1.0 era). **Hub production:** [v1.3.0](docs/RELEASE_v1.3.0.md). **v1.4.0 pending sign-off:** [RELEASE_v1.4.0.md](docs/RELEASE_v1.4.0.md) · [PLAN](docs/PLAN_v1.4.0.md) on `v1.4.0-dev`.  
