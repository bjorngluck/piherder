...
> **Status:** Historical phase checklist (v1.0 era). **Hub production:** [v1.2.0](docs/RELEASE_v1.2.0.md). **Active train:** [v1.3.0](docs/PLAN_v1.3.0.md) on `v1.3.0-dev`.  
> **Last updated:** 2026-08-18 — do not treat this file as the operator guide (use the wiki + RELEASE).
...
- [ ] Service migrate host→host; destructive service remove — **→ v1.4 Stream M** ([docs/PLAN_v1.4.0.md](docs/PLAN_v1.4.0.md) · [docs/FEATURE_PLAN_SERVICE_MIGRATION.md](docs/FEATURE_PLAN_SERVICE_MIGRATION.md)); host lock (HAOS / hardware); destructive wipe later
