...
**Mode:** **Shipped.** Next trains: [PLAN_v1.4.0.md](PLAN_v1.4.0.md) (**tagged**) · [PLAN_v1.5.0.md](PLAN_v1.5.0.md) (**Active**).  
...
Service migration is [PLAN_v1.4.0.md](PLAN_v1.4.0.md) (**tagged**). Next train: [PLAN_v1.5.0.md](PLAN_v1.5.0.md) on `v1.5.0-dev` (opened 2026-09-07).

---

*Shipped as [RELEASE_v1.3.0.md](RELEASE_v1.3.0.md). Next: [PLAN_v1.4.0.md](PLAN_v1.4.0.md) (tagged) · [PLAN_v1.5.0.md](PLAN_v1.5.0.md) (Active).*
