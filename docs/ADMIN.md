...
| Host lifecycle plan (H2.75) | `docs/FEATURE_PLAN_HOST_LIFECYCLE.md` — Docker bulk (**0.6**); wizard onboard (**0.7 product-done** — `docs/PLAN_v0.7.0.md`); host stats/commands capacity in **0.8 RC3** (`docs/PLAN_v0.8.0.md`); bootstrap/DNS, web SSH later |
