...
**Not parked here:** remaining 1.5 Discover catalog (Brand, M-flag, W-mux, J-runtime) — write those notes on the 1.5 train if we write them; promote later. **HA-p2 / M-undo write-ups are done** (1.5); **ship** stays this inbox.
