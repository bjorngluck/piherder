...
**Decision (2026-08-19):** **Slice 1 Deep landed** (P + T1–T6). **Slice 2 Deep landed** (W-cfg: Settings → Console timeouts / concurrency / bind; kill switch env-only). **Slice 3 Deep landed** (L: Servers / Docker / discovery search + pager). Next: **W-id** Connect as….
