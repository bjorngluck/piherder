...
!!! tip "Home Assistant"
    ...
    **Path 2 (v1.6):** HA **observes** the PiHerder fleet via HACS — [Home Assistant → PiHerder](home-assistant.md). Token `read`; poll snapshots only. Plugin **0.2.2**: Visit on the host device; fleet Lovelace card for totals and section chips.
