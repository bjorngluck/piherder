...
!!! tip "Prefer tags"
    Prefer **tagged production releases** (`v1.0.0` / later `1.0.x`). Treat untagged `main` as moving. See [Home](../index.md#release-status) · [RELEASE_v1.0.0.md](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.0.0.md).
...
# optional pin: PIHERDER_IMAGE=bjorngluck/piherder:1.0.0 docker compose up -d
```
...
- [ ] Read [RELEASE notes](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.0.0.md) for the version you jump to  
- [ ] `docker compose ps` healthy (image `bjorngluck/piherder:…`)  
- [ ] Smoke: login, Users recovery (if multi-user), one server, optional template  
