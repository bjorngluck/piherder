...
# optional pin: PIHERDER_IMAGE=bjorngluck/piherder:0.9.0 docker compose up -d
```
...
- [ ] Read [RELEASE notes](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v0.9.0.md) for the version you jump to  
