...
!!! warning "RC line"
    Prefer **tagged releases** (`v0.8.0`); treat `main` as moving. See [Home](../index.md#rc1).
...
# optional pin: PIHERDER_IMAGE=bjorngluck/piherder:0.8.0 docker compose up -d
```
...
- [ ] Read [RELEASE notes](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v0.8.0.md) for the version you jump to  
