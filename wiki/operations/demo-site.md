...
- **Service migrate is off** — no dest picker, no dataset copy. Host **lock / unlock** exists on a real install without the migrate flag. [Move a service](../docker/service-migration.md).  
