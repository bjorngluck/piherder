...
The **operator freeze checklist** for **PiHerder v1.2.0**. This is a **prior** production line (prefer **[v1.4.0](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.4.0.md)**). Use the list to sign off a fleet still on 1.2.
...
**v1.4.0** is tagged production. This page stays the **1.2 production** checklist.
...
[Home](../index.md#release-status) lists **v1.4.0** as current production. Hub tags for this line: `1.2.0` / `1.2`.
