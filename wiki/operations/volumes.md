...
|-----------|-----------|---------|-----------------|
| `${PIHERDER_BACKUP_HOST_PATH:-./backups}` | `/backups` | rsync destinations for **server** backups; migrate staging under `_migrate/{job_id}/` (mode 700; **wiped on success**, **kept on failure** — delete leftover dirs yourself) | **No** — separate DR ([Backups](../day-to-day/backups.md) · [Move a service](../docker/service-migration.md)) |
