...
**Release notes:** [docs/RELEASE_v1.3.0.md](../docs/RELEASE_v1.3.0.md) (current Hub) · **[v1.4.0 pending](../docs/RELEASE_v1.4.0.md)** · [docs/RELEASE_v1.2.0.md](../docs/RELEASE_v1.2.0.md) · [docs/RELEASE_v1.1.1.md](../docs/RELEASE_v1.1.1.md) · [docs/RELEASE_v1.1.0.md](../docs/RELEASE_v1.1.0.md) · prior [docs/RELEASE_v1.0.0.md](../docs/RELEASE_v1.0.0.md)  
...
| `day-to-day/web-ssh-console.md` | Web SSH console (flag-off; Settings → Console for limits; Connect as… privileged) |
