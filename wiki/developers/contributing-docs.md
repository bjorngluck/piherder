...
- **v0.6.0 RC2** shipped — [`RELEASE_v0.6.0.md`](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v0.6.0.md). Active product cycle: **v0.7.0** wizard + screenshot pack + **Playwright E2E** — [`PLAN_v0.7.0.md`](https://github.com/bjorngluck/piherder/blob/main/docs/PLAN_v0.7.0.md) (stream E).  
