...
!!! tip "Production install"
    Prefer a **tagged** image (`1.3.0` / `1.3` / `latest` until **v1.4.0** tags). Release notes: [RELEASE_v1.3.0.md](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.3.0.md) · [v1.4.0 pending](https://github.com/bjorngluck/piherder/blob/v1.4.0-dev/docs/RELEASE_v1.4.0.md).
