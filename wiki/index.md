...
| **Next** | **v1.6.0 train** on `v1.6.0-dev` — Mux-1 landed (operator QA) · HACS path 2 on [bjorngluck/piherder-ha](https://github.com/bjorngluck/piherder-ha) **0.2.2** (**Visit** + fleet Lovelace card) · host-facts snapshot in System Info · unit **75.04%** (CI fail-under **75**). [PLAN](https://github.com/bjorngluck/piherder/blob/v1.6.0-dev/docs/PLAN_v1.6.0.md). Production stays **v1.5.0**. |
