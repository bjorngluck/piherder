...
| **Next release** | **v1.4.0** — [Move a service](docker/service-migration.md) + demo simulated [Host Files](day-to-day/host-files.md) (**Active** on [`v1.4.0-dev`](https://github.com/bjorngluck/piherder/tree/v1.4.0-dev); Hub/`main` stay **1.3.0** until freeze). [PLAN_v1.4.0.md](https://github.com/bjorngluck/piherder/blob/v1.4.0-dev/docs/PLAN_v1.4.0.md). |
