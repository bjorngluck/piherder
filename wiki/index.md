...
| **Next** | **v1.7.0 train opened** on `v1.7.0-dev` — token-API MCP first (**MCP-1**, read and write), then remaining exclusive jobs on Celery (**Jr-1**). Technical: [PLAN_v1.7.0.md](https://github.com/bjorngluck/piherder/blob/v1.7.0-dev/docs/PLAN_v1.7.0.md). Production stays **v1.6.0**. |
