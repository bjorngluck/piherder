...
| **Next** | **v1.5 candidate** — Move job on Celery worker (**M-worker**). Not opened. Technical record: [PLAN_v1.4.0.md](https://github.com/bjorngluck/piherder/blob/main/docs/PLAN_v1.4.0.md) §6. |
