...
| **Next** | **v1.6.0 train opened** on `v1.6.0-dev` — HACS on Home Assistant (**HA-p2 Slice 1**) · host console mux (**Mux-1**) · unit ≥ 75%. Technical: [PLAN_v1.6.0.md](https://github.com/bjorngluck/piherder/blob/v1.6.0-dev/docs/PLAN_v1.6.0.md). Production stays **v1.5.0**. |
