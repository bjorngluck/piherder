...
| **Next release** | **v1.3.0** — **active train** on `v1.3.0-dev` (operator policy · scale lists · multi-identity console · insights / host files thin slice). [PLAN_v1.3.0.md](https://github.com/bjorngluck/piherder/blob/v1.3.0-dev/docs/PLAN_v1.3.0.md) |
