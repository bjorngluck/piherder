...
| **Next** | **v1.5.0** on `v1.5.0-dev` — **landed:** Move on Celery (**M-worker**), Reports pin/hide/reorder (**N3a**), unit coverage **≥ 70%**. Remaining: Discover notes, leftover Move recycle QA, freeze (**M-flag**, tag, Hub). Technical: [PLAN_v1.5.0.md](https://github.com/bjorngluck/piherder/blob/v1.5.0-dev/docs/PLAN_v1.5.0.md). Production stays **v1.4.0**. |
