...
| | |
|---|---|
| **Current release** | **[v1.5.0](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.5.0.md)** — Move on Celery (recycle **web** is safe) · Reports pin/hide/reorder · Sign in on expired session · [Move a service](docker/service-migration.md) still flag off |
| **Image** | `bjorngluck/piherder:1.5.0` · `1.5` · `latest` (multi-arch amd64 + arm64; `1.4.0` / `1.4` / `1.3.x` pins remain valid). Hub tags land with git tag `v1.5.0`. |
| **Release notes** | [RELEASE_v1.5.0.md](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.5.0.md) · [v1.4.0](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.4.0.md) · [v1.3.0](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.3.0.md) · [v1.2.0](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.2.0.md) · [v1.1.1](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.1.1.md) · [v1.1.0](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.1.0.md) · prior [v1.0.0](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.0.0.md) |
...
| **Next** | **v1.6.0** is in **code freeze** on `v1.6.0-dev` (operator QA signed 2026-09-24). Mux-1 · HACS [bjorngluck/piherder-ha](https://github.com/bjorngluck/piherder-ha) **0.2.4** · script-nonce CSP (home enforces; public demo Report-Only) · fail-path Move undo · unit coverage over **75%** (CI fail-under **75**). Screenshots next, then the version bump. [PLAN](https://github.com/bjorngluck/piherder/blob/v1.6.0-dev/docs/PLAN_v1.6.0.md). Production stays **v1.5.0**. The public demo is already on this branch (footer still 1.5.0, Move off). |
