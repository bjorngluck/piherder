...
| **Next** | **v1.5.0 train opened** on `v1.5.0-dev` — Move on Celery worker (**M-worker**) · Reports layout (**N3a** Should). Technical: [PLAN_v1.5.0.md](https://github.com/bjorngluck/piherder/blob/v1.5.0-dev/docs/PLAN_v1.5.0.md). Production stays **v1.4.0**. |
