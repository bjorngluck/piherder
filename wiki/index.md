...
| **Next** | **v1.7** is a parked inbox (not opened): remaining jobs on Celery, branding, finer grants, a read-only MCP adapter. [PLAN](https://github.com/bjorngluck/piherder/blob/main/docs/PLAN_v1.7.0.md). |
