...
| **Next release** | **v1.3.0** — **active train** on `v1.3.0-dev`. Landed: password / 2FA policy · console timeouts · scale lists · **Connect as…** · opt-in **command audit** · alert policy · **Reports** · **Host Files** (flag off until you enable `PIHERDER_HOST_FILES`). [PLAN_v1.3.0.md](https://github.com/bjorngluck/piherder/blob/v1.3.0-dev/docs/PLAN_v1.3.0.md) |
