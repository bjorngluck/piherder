...
| **Next** | **v1.6.0** candidate — HACS integration on Home Assistant. Technical: [PLAN_v1.6.0.md](https://github.com/bjorngluck/piherder/blob/main/docs/PLAN_v1.6.0.md). Production is **v1.5.0**. |
