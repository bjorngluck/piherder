...
| **Next** | **v1.6.0 train** on `v1.6.0-dev` — **Mux-1 landed** (opt-in host tmux/screen, operator QA) · HACS Slice 1 still open · unit ≥ 75% in progress. Technical: [PLAN_v1.6.0.md](https://github.com/bjorngluck/piherder/blob/v1.6.0-dev/docs/PLAN_v1.6.0.md). Production stays **v1.5.0**. |
