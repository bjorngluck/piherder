...
| **Next** | **v1.6.0 train** on `v1.6.0-dev` — Mux-1 (operator QA) · HACS [bjorngluck/piherder-ha](https://github.com/bjorngluck/piherder-ha) **0.2.4** · script-nonce CSP (home enforces; public demo Report-Only) · fail-path Move undo · unit **75.04%** (CI fail-under **75**). [PLAN](https://github.com/bjorngluck/piherder/blob/v1.6.0-dev/docs/PLAN_v1.6.0.md). Production stays **v1.5.0**. The public demo is already on this branch (footer still 1.5.0, Move off). |
