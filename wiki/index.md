...
| | |
|---|---|
| **Current release** | **[v1.6.0](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.6.0.md)** — HACS fleet card · console mux · script nonce · fail-path Move undo · [Move a service](docker/service-migration.md) still flag off |
| **Image** | `bjorngluck/piherder:1.6.0` · `1.6` · `latest` (multi-arch amd64 + arm64; `1.5.0` / `1.5` / `1.4.x` pins remain valid). Hub tags land with git tag `v1.6.0`. |
| **Release notes** | [RELEASE_v1.6.0.md](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.6.0.md) · [v1.5.0](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.5.0.md) · [v1.4.0](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.4.0.md) · [v1.3.0](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.3.0.md) · [v1.2.0](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.2.0.md) · [v1.1.1](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.1.1.md) · prior [v1.0.0](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.0.0.md) |
...
| **Next** | **v1.7.0** on `v1.7.0-dev`. [Agents (MCP)](operations/mcp.md) **0.1.0** (own repo, read and write of today’s API token). On the branch: remaining exclusive jobs on Celery (including host reboot), a Settings wait for a host that is down, [Appearance](getting-started/appearance.md) (instance name, one accent, hide Catalog in the nav), and coverage fail-under **80**. [Home Assistant](integrations/home-assistant.md) plugin **0.3.0** adds a host card, an updates card, a resources card, and confirm writes. Operator walks are still open. Technical: [PLAN_v1.7.0.md](https://github.com/bjorngluck/piherder/blob/v1.7.0-dev/docs/PLAN_v1.7.0.md). Production stays **v1.6.0**. |
