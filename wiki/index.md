...
| | |
|---|---|
| **Current release** | **[v1.4.0](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.4.0.md)** — [Move a service](docker/service-migration.md) (flag off) · demo simulated [Host Files](day-to-day/host-files.md) · plus 1.3 policy, Reports, Files, console |
...
| **Release notes** | [RELEASE_v1.4.0.md](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.4.0.md) · [v1.3.0](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.3.0.md) · [v1.2.0](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.2.0.md) · [v1.1.1](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.1.1.md) · [v1.1.0](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.1.0.md) · prior [v1.0.0](https://github.com/bjorngluck/piherder/blob/main/docs/RELEASE_v1.0.0.md) |
...
| **Next** | **v1.5.0** on `v1.5.0-dev` — **landed:** Move on Celery (**M-worker**), Reports pin/hide/reorder (**N3a**), Move jobs card (**N3b**), unit coverage **≥ 70%**. Remaining: Discover notes, leftover Move recycle QA, freeze (**M-flag**, tag, Hub). Technical: [PLAN_v1.5.0.md](https://github.com/bjorngluck/piherder/blob/v1.5.0-dev/docs/PLAN_v1.5.0.md). Production stays **v1.4.0**. |
