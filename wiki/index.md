...
| **Next release** | **v1.3.0** — **active train** on `v1.3.0-dev`. Landed: password / 2FA policy · console timeouts in Settings · scale lists (Servers / Docker / discovery). Still open: Connect as… · insights / host files. [PLAN_v1.3.0.md](https://github.com/bjorngluck/piherder/blob/v1.3.0-dev/docs/PLAN_v1.3.0.md) |
