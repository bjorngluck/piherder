...
| **Next release** | **v1.3.0** — **feature freeze** (2026-08-22) on `v1.3.0-dev`. Landed: password / 2FA policy · console timeouts · scale lists · **Connect as…** · opt-in **command audit** · alert policy · **Reports** (history, not widgets) · **Host Files** confined manager (flag off — not a WinSCP clone). Draft notes: [RELEASE_v1.3.0.md](https://github.com/bjorngluck/piherder/blob/v1.3.0-dev/docs/RELEASE_v1.3.0.md). |
