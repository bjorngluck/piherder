...
| **v1.5.0** | Dev train on `v1.5.0-dev` — recapture **Reports** pin/hide/reorder + **Move jobs** card at freeze. Move JobHold shots still valid. Rebuild **web and celery-worker**. [PLAN](../../../docs/PLAN_v1.5.0.md) |
